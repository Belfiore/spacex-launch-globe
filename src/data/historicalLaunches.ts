...
export const HISTORICAL_LAUNCHES: Launch[] = [
...

  {
    ...
    failureSummary: "Multiple engine failures, vehicle tumbled, AFTS triggered at T+4 min",
    exploded: true,
    explosionPhase: "ascent",
    vehicleLost: true,
    details:
...

  {
    ...
    rocketType: "Starship",
    launchStatus: "failure",
    failureCategory: "propulsion_anomaly",
    failureSummary: "Booster exploded during boostback burn; Ship AFTS triggered at T+8 min",
    exploded: true,
    explosionPhase: "boostback",
    vehicleLost: true,
    details:
...

  {
    ...
    rocketType: "Falcon 9",
    launchStatus: "failure",
    failureCategory: "structural_failure",
    failureSummary: "Vehicle broke apart at T+139s — helium COPV strut failure in second stage LOX tank",
    exploded: true,
    explosionPhase: "ascent",
    brokeUp: true,
    vehicleLost: true,
...

  {
    ...
    status: "failure",
    rocketType: "Falcon 9",
    launchStatus: "prelaunch_failure",
    failureCategory: "pad_anomaly",
    failureSummary: "Exploded on pad during static fire propellant loading — COPV buckle in LOX tank",
    failureDetail: "During propellant loading for a static fire test, a helium COPV buckled inside the second-stage LOX tank, causing rapid unscheduled disassembly. Vehicle and $200M AMOS-6 satellite destroyed. SLC-40 pad heavily damaged.",
    exploded: true,
    explosionPhase: "pad_static_fire_prep",
    vehicleLost: true,
